    ...
    <div className="relative">
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="flex items-center gap-1 flex-shrink-0">
            ...
            <button
              ...
              className="p-1 text-slate-500 hover:text-slate-300 rounded opacity-0 group-hover:opacity-100 transition-opacity"
      ...
      {showMenu && (
        <>
          ...
          <div className="absolute right-2 top-full mt-1 z-20 w-40 bg-slate-800 border border-slate-700 rounded-lg shadow-xl py-1">
            {onTogglePin && (
              <button
...
export function ConversationList({
  ...
  return (
    <div className={`flex flex-col h-full ${className}`}>
      {/* Header */}
      <div className="flex-shrink-0 p-4 border-b border-symtex-border">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:border-symtex-primary/50 transition-colors"
          />
        </div>
      ...
      <div className="flex-1 overflow-y-auto p-2 space-y-1">
        ...
        {pinnedConversations.length > 0 && (
          <div className="mb-4">
            <h3 className="px-3 py-2 text-xs font-medium text-slate-500 uppercase tracking-wider">
              Pinned
            </h3>
        ...
        {filteredConversations.length === 0 && (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            {!search && (
              <button
                onClick={onNewConversation}
                className="mt-4 px-4 py-2 bg-symtex-primary text-white rounded-lg text-sm font-medium hover:bg-symtex-primary/80 transition-colors"
              >
                New Conversation
              </button>
            )}
