 ...
 *
 * Displays a grid of available agent templates with filtering,
...
const categoryTabs: CategoryTab[] = [
  {
    ...
    label: 'All Agents',
    icon: Bot,
    description: 'View all available agent templates',
  },
  {
    id: 'sibling',
    label: 'Sibling',
    icon: Users,
    description: 'Multiple agents work independently',
  },
  {
    id: 'debate',
    label: 'Debate',
  ...
  },
  {
    ...
    label: 'Family',
    icon: Users,
    description: 'Hierarchical with supervisor agent',
  },
  {
    id: 'waves',
    label: 'Waves',
...
export default function AgentRoster({
  ...
  const { templates, getInstances, selectTemplate } = useAgentStore();
      ...
      <div className="flex-1 overflow-y-auto">
        {filteredTemplates.length > 0 ? (
          ...
          <EmptyState
            ...
            title={searchQuery ? 'No agents found' : 'No agent templates'}
            description={
              searchQuery
